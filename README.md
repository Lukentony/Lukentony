# 💫 About Me:
About Me:<br>Hi, I’m Luca, a 33-year-old developer from Turin who converts caffeine into code.<br><br>I'm currently working on:<br>Leveling up my skills and surviving my own syntax errors.<br><br>I'm looking to collaborate on:<br>Anything where 3D printing meets tech (let's build something tangible!).<br><br>I'm looking for help with:<br>Making my code run faster than my motorbike.<br><br>I'm currently learning:<br>The holy trinity: Python, JavaScript, and C#.<br><br>Ask me about:<br>My motorbike trips or how many times I've had to restart a 3D print.<br><br>Fun fact:<br>I don't just print upgrades for my printer; I've designed a whole collection of custom gadgets!
